...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <main class="snap-y snap-mandatory scroll-smooth h-screen duration-300">
        ...
        <div class="items-center justify-center md:flex">
            <img src="{{ asset('assets/hero.jpg') }}" alt="hero-pict" class="object-cover md:max-w-[600px] md:h-full w-full h-70 shadow-xl shadow-choco/100">
        </div>
    </div>
    <!--Product Section-->

    <div id="product" class="h-fit snap-start snap-normal flex flex-col bg-gradient-to-b from-[#31211B] to-[#644337]">
        <!--Title and Description-->
        ...
        <div class=" px-10 py-20">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-20 md:max-w-6xl md:w-full w-90 mx-auto">
        ...
        <div class="flex justify-center md:mt-[-25px] mb-10 md:mb-0 flex-row md:ml-140">
            <button onclick="location.href='{{ route('user.order') }}'" class="bg-[#E8D9D0] text-choco rounded-lg text-[17px] h-max hover:bg-[#D5C3C1] transition-all duration-300 ease-in delay-75 justify-center items-center flex">
                <span class="pl-5 py-3">Order Now</span>
                {{-- <div class="inline-flex ml-5 h-12 w-1 bg-[#979797]">
                </div> --}}
                <img src="{{ asset('assets/panah-kanan.svg') }}" alt="arrow-right" class="h-[30px] object-cover px-1 hover:translate-x-1 transition-transform duration-300">
            </button>
        </div>
        </div>
    </div>
    <!--About Us Section-->
    <div id="aboutUs" class="h-fit snap-start snap-normal bg-linear-to-b from-[#644337] to-[#A98168] py-20">
        <div class="px-10 lg:px-30 flex flex-col md:flex-row justify-evenly items-center text-center">

            <div class="flex flex-col items-left mb-10 md:mb-0">
                <h2 class="text-[#ffffff] font-ebGaramond text-[25px] mb-2">Customer & Clients</h2>
                <p class="text-[#F1E6D9] font-dmSerifText italic text-[70px] ">50+</p>
                <p class="text-[#F1E6D9] font-albertSans text-[18px] italic max-w-xs opacity-90">
                    We served more than 550 customers
                </p>
            </div>

            <div class="flex flex-col items-left mb-10 md:mb-0">
                <h2 class="text-[#ffffff] font-ebGaramond text-[25px] mb-2">Completing Project</h2>
                <p class="text-[#F1E6D9] font-dmSerifText italic  text-[70px] ">&plusmn;1,250</p>
                <p class="text-[#F1E6D9] font-albertSans text-[18px] italic max-w-xs opacity-90">
                    Has made 1,250 meters design
                </p>
            </div>

            <div class="flex flex-col items-left">
                <h2 class="text-[#ffffff] font-ebGaramond text-[25px] mb-2">Expert Team</h2>
                <p class="text-[#F1E6D9] font-dmSerifText italic text-[70px] ">3</p>
                <p class="text-[#F1E6D9] font-albertSans text-[18px] italic max-w-xs opacity-90">
